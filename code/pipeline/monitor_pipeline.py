...
def main():
    ...
    parser.add_argument('-log', '--logging', default=False, type=bool,
    ...
    if args.loop:
        ...
        if args.logging:
            try:
                pipe_monitor.parse_extension(logext='*.log', outname='pipeline_CPUs=' + str(args.maxthreads) + '.csv', time_shift=TIME_ZONE_SHIFT)
            except ValueError:
                print 'no log file(s) found'
