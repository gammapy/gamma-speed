#!/usr/bin/env python
"""
Plot the results of the monitoring
"""
...
def pipeline_separate_plots(my_plotter, outpref, log_exists=False):
    ...
    """
    my_plotter.CPU_plot('plots/CPU' + outpref)
    my_plotter.MEM_plot('plots/mem' + outpref)
    my_plotter.IO_cumulative_plot('plots/io_cumul' + outpref)
    my_plotter.IO_speed_plot('plots/io_speed' + outpref)
    my_plotter.IO_read('plots/io_read' + outpref)
...
def pipeline_speed_up(my_plotter, outpref, log_exists):
    ...
    if log_exists:
        ...
        plt.figure(21)
        my_plotter.splot(
            figtitle='Overall speed up and efficiency for pipeline',
        ...
        plt.figure(20)
        my_plotter.splot(
            figtitle='Parallel speed up and efficiency for pipeline',
