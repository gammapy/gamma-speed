...
if __name__ == '__main__':
    ...
    parser.add_argument("-infile", type=str,
                        help="name of file containing the events/list " +
                        " of event files",
    ...
    parser.add_argument("-outfile", type=str,
                        ...
                        default='fit_results.xml')
    parser.add_argument("-binfile", type=str,
                        help="name of file containing ctbin output",
                        default='bin_results.xml')
    parser.add_argument("-binned", type=bool,
                        help="do binned or unbinned analysis",
                        default=False)

    args = parser.parse_args()

    if args.binned:
        ctlike_binned(args.infile, args.binfile, 0.1, 100.0, 20, 200, 200,
                      0.02, 83.63, 22.01, args.irf, args.caldb, args.outfile)
    else:
