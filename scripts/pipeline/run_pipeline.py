#! /usr/bin/env python
"""
In order to see OpenMP parallel behaviour, the pipeline needs to be fed
with multiple oberservations. This means that multiple observations need
to be simulated in a similar fashion as to the one from run_multi_ctobssim
"""
from ctools import *
